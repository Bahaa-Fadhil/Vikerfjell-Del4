...
<!--  -->
<script type="text/javascript" src="sidene/functions/funksjoner.js"></script>
<!--  -->    
</head>
<body>
<!-- her lager jeg en ny nav "joacim bergh" -->
<header>
  <a href="sidene/default.php" id="logo"><img id="logo-img" src="../Bilder/Logo/logo-vikerfjell.png" height="62px" width="83px"></a>
    <ul class="topnav" id="mytopnav">
		<!-- SQL:select * from meny order by rekke; -->
<li><a href='lagetest.html'>LAGETEST</a></li>
 <li><a href='test.html'>TEST</a></li>
 <li><a href='HEI.html'>HEI</a></li>
 ...
 <li><a href='Veiogfore.html'>VEI OG FØRE</a></li>
 <li><a href='lag.html'>SLUTT</a></li>
 <li><a href='trololo.html'>Å</a></li>
 <li><a href='omoss.html'>OMOSS</a></li>
 <li><a href='test2.html'>KØDD</a></li>
 		<div id="wrap">
...
<!-- slutt på header -->
<!-- header tekst ---><div class="grid topp">
<!--Row-->
    <div class="row2">
    	<div class="col-sm-12">
...
<!------------------start på artikkler ------------------>
<div class='grid'><div class='row2'></div></div><!----------------------------------Slutt på artikkler---------------------------->
...
<li><a href='lagetest.html'>LAGETEST</a></li>
 ...
 <li><a href='test2.html'>KØDD</a></li>
            ...
            <div class="col-md-4 col-sm-4">
                <div class="center">
                    <a href="https://home.usn.no/web-r-gpro1/index.html">
                       <!--<img src="Bilder/Logo/logo-vikerfjell.png" width="200px" height="120px" style="text-align: center">-->
                        <h3 class="vikerfjell-rett">© Vikerfjell.com </h3>
                    </a>
                </div>
            </div>
            <div class="col-md-4 col-sm-4">
               <div class="share-icons">
                    <!--<h3 class="footer-tekst">Følge Oss på</h3> -->
